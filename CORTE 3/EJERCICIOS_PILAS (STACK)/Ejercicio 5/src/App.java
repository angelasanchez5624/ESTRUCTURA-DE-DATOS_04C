...
public class App {
    ...
    public static void main(String[] args) {
        ...
        cueva.push(new Estacion("Entrada", 10, 21.0));
        cueva.push(new Estacion("Zona Rocosa", 30, 19.5));
        cueva.push(new Estacion("Túnel Oscuro", 50, 17.2));
        cueva.push(new Estacion("Cámara Profunda", 80, 15.8));
