...
public class App {
    ...
    public static void main(String[] args) {
        ...
        callejon.push(new Camion("ABC123", "Carlos", 4.5));
        callejon.push(new Camion("DEF456", "Andrés", 6.2));
        callejon.push(new Camion("GHI789", "María", 3.8));
        callejon.push(new Camion("JKL321", "Laura", 7.1));
        ...
        do {
            ...
            System.out.println("3. Retirar camión");
